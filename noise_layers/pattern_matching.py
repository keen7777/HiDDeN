...
class PatternMatching(nn.Module):
    ...
    def __init__(self, mask_size_range, seed=42):
        super(PatternMatching, self).__init__()
        self.mask_min = mask_size_range[0]
        self.mask_max = mask_size_range[1]
    ...
    def forward(self, noised_and_cover):
        ...
        # position of mask
        top = np.random.randint(1, H - mask_h - 1)
        left = np.random.randint(1, W - mask_w - 1)
