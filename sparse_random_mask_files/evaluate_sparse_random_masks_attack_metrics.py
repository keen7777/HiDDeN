...
DEFAULT_MASK_FILE = (
    "/home/keen/HiDDeN/sparse_random_masks_data/random_masks_den_0.1_seed_42/val_random_masks_density_100.npy"
)
...
class PrecomputedSparseRandomMaskInpainting(nn.Module):
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate HiDDeN using pre-generated random sparse masks "
    ...
    parser.add_argument(
        "--output-root",
        default="./sparse_random_mask_eval_outputs_metrics",
    )
    ...
    external_attack = PrecomputedSparseRandomMaskInpainting(
